          ...
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="mx-auto mt-4 max-w-2xl text-muted-foreground text-lg leading-relaxed">
                Every GuideSoft instructor has built production systems at India's top tech
                companies. They left senior roles because they believe in mission-driven teaching —
                and they bring real industry context to every class.
              </p>
