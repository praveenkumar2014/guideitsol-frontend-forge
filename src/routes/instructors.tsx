...
const instructors = [
  {
    ...
    achievements: ["Built Infosys's internal API gateway serving 2M+ requests/day", "AWS Certified Solutions Architect Professional", "Spoke at 8 national tech conferences"],
  ...
  },
  {
    ...
    rating: 4.9,
    students: "3,800+",
    courses: ["Python Full Stack & GenAI Engineering", "Data Science & ML", "Generative AI Engineering"],
    ...
    achievements: ["40+ research publications in top ML conferences (NeurIPS, ICML)", "Contributed to Google PaLM language model architecture", "TED-style talk on 'AI for Bharat' viewed 800K+ times on YouTube"],
  ...
  },
  {
    ...
    achievements: ["AWS Certified in 8 specializations (Pro + Specialty level)", "Designed AWS infrastructure for 3 NSE-listed companies", "Saved clients $2M+ in annual cloud costs through right-sizing"],
  ...
  },
  {
    ...
    rating: 4.8,
    students: "6,200+",
    courses: ["Data Science & Machine Learning", "Power BI & Data Analytics", "Business Intelligence"],
    ...
    achievements: ["Built Flipkart's recommendation engine (₹200Cr+ GMV impact)", "HDFC Bank fraud detection: reduced false positives by 40%", "IIT Kharagpur Young Alumni Award 2022"],
  ...
  },
  {
    ...
    rating: 4.8,
    students: "3,600+",
    courses: ["Selenium & API Testing Automation", "SDET Bootcamp", "Performance Testing with JMeter"],
    ...
    achievements: ["ISTQB Certified Test Manager & Expert (Level 3)", "Built HCL's enterprise QA framework adopted by 10,000+ developers", "Keynote speaker: India Testing Conference 2019, 2022, 2024"],
  ...
  },
  {
    ...
    rating: 4.9,
    students: "4,800+",
    courses: ["React & Next.js Frontend Development", "TypeScript Masterclass", "UI/UX Product Design"],
    ...
    achievements: ["Razorpay mobile checkout redesign: +23% conversion improvement", "Speaker: ReactConf India 2022, JSConf Asia 2023", "Creator of popular open-source React hooks library (2.1k GitHub stars)"],
  ...
  },
  {
    ...
    achievements: ["Led SAP FICO implementations for 30+ Fortune 500 companies", "SAP Certified Professional (FI, CO, S/4HANA Finance)", "Deloitte India Outstanding Performer Award 2019"],
  ...
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1542178243-bc20204b769f?w=400&auto=format&fit=crop&q=80",
    exp: "9 years",
    ...
    achievements: ["Ola Electric app: 1.5M+ downloads, 4.7★ App Store rating", "Led mobile engineering for Byju's offline learning feature (30M users)", "Flutter contributor: 3 accepted PRs to the main repository"],
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-display text-4xl font-bold tracking-tight sm:text-5xl">
              ...
              <span className="text-gradient">not textbooks</span>
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground text-lg leading-relaxed">
              Every GuideSoft instructor has built production systems at India's top tech companies. They left senior roles because they believe in mission-driven teaching — and they bring real industry context to every class.
            </p>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {instructors.map((inst, i) => (
            ...
            >
              <div className="flex gap-6 p-6">
                ...
                <div className="min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h2 className="font-display text-lg font-semibold text-foreground">{inst.name}</h2>
                      <p className="text-sm text-primary font-medium">{inst.role}</p>
                      <p className="text-xs text-muted-foreground mt-0.5">{inst.exp} · {inst.prevOrg}</p>
                    </div>
              ...
              <div className="px-6 pb-6">
                <EnquiryDialog courseName="Instructor Session Enquiry">
                  <Button size="sm" className="w-full rounded-xl" id={`enquire-${inst.name.replace(/\s/g, "-").toLowerCase()}`}>
