    ...
    <div className="relative min-h-screen bg-background text-foreground transition-colors duration-200">
      ...
      <section className="border-b border-border/80 bg-surface/50 py-10 backdrop-blur-md">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <StaggerContainer className="grid grid-cols-2 gap-6 sm:grid-cols-4" staggerDelay={0.1}>
        ...
        <AnimatedSection direction="left">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <Badge
                variant="outline"
                className="border-primary/40 bg-primary/10 text-primary mb-3"
              >
            ...
            >
              {roles.map((role) => {
                ...
                return (
                  <motion.div variants={staggerItem} key={role.name}>
                    <Link
                      to="/courses"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              {exploreCategories.map((cat) => {
                ...
                return (
                  <motion.div variants={staggerItem} key={cat.name}>
                    <Link
                      to="/browse/$category"
            ...
            {activeCertCategory && (
              ...
              >
                {activeCertCategory.certificates.map((cert) => (
                  <motion.div variants={staggerItem} key={cert}>
                    <Link
                      to="/courses"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              {trendingSkills.map((skill) => (
                <motion.div variants={staggerItem} key={skill.name}>
                  <Link
                    to="/courses"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              {certificationExams.map((exam) => (
                <motion.div variants={staggerItem} key={exam.code}>
                  <Link
                    to="/courses"
                    className="group rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:-translate-y-0.5"
                  >
        ...
        <AnimatedSection direction="right" delay={0.1}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer className="mt-14 grid gap-6 md:grid-cols-3" staggerDelay={0.1}>
              <motion.div
                variants={staggerItem}
                className="rounded-3xl border border-border bg-card p-7 shadow-sm transition-all duration-300 hover:border-primary/50 hover:shadow-xl"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary">
              ...
              >
                ...
                <p className="mt-2.5 text-xs sm:text-sm leading-relaxed text-muted-foreground">
                  Resume optimization, system design mock interviews, verified credential ledgers,
                  and direct referrals to 150+ hiring partners.
                </p>
              </motion.div>
            </StaggerContainer>
          </div>
