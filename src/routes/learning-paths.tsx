...
const paths = [
  {
    ...
    description:
      "The most comprehensive path to becoming a complete full-stack engineer. You choose your backend language (Java or Python), master a production framework, build a React frontend, and deploy to AWS Cloud — with system design and interview preparation woven throughout.",
    stages: [
      {
        name: "Foundation",
        weeks: "4 weeks",
      ...
      },
      {
        ...
        weeks: "14 weeks",
        courses: [
          "Java Full Stack Development OR Python Full Stack & GenAI",
          "REST API Design",
      ...
      },
      {
        ...
        courses: [
          ...
          "Placement Program (6 mock interviews)",
        ],
      },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Go from zero to a production-ready AI/ML Engineer. This path covers the complete data science spectrum — from exploratory analysis and ML algorithms to deep learning, generative AI with LLMs, and deploying models to production with MLOps practices.",
    stages: [
      {
      ...
      },
      {
        ...
        weeks: "8 weeks",
        courses: [
          "Data Science & Machine Learning (Full Course)",
      ...
      },
      {
        ...
        weeks: "10 weeks",
        courses: [
          "Python Full Stack & Generative AI Engineering",
    ...
    outcomes: [
      "End-to-end ML models in production",
  ...
  },
  {
    ...
    description:
      "Become the cloud infrastructure expert every engineering team desperately needs. This path takes you from Linux fundamentals through containerization, Kubernetes orchestration, AWS cloud architecture, and infrastructure as code — culminating in AWS certification readiness.",
    stages: [
      {
      ...
      },
      {
        ...
        weeks: "8 weeks",
        courses: [
          "AWS Cloud & DevOps Engineering (Full Course)",
  ...
  },
  {
    ...
    description:
      "Software quality engineering is one of the most accessible entry points into tech. This path takes you from programming basics through the complete SDET toolkit — Selenium automation, API testing, performance testing with JMeter, and integrating quality gates into CI/CD pipelines.",
    stages: [
      {
        name: "Java & Testing Basics",
        weeks: "4 weeks",
        courses: [
          "Java for Testers",
          "Software Testing Fundamentals (ISTQB concepts)",
          "JIRA & Agile QA Practices",
        ],
      },
      {
        name: "Web Automation with Selenium",
        weeks: "6 weeks",
        courses: [
          "Selenium & API Testing Automation (Full Course)",
      ...
      {
        name: "DevOps Integration & Career",
        weeks: "4 weeks",
        courses: [
          "GitHub Actions QA Pipelines",
    ...
    outcomes: [
      "Complete Selenium + API test suites",
  ...
  },
  {
    ...
    description:
      "The dedicated path for engineers who want to master the craft of frontend engineering — where pixel-perfect design meets performant, accessible code. Covers the complete React ecosystem including Next.js 14, TypeScript, and production-grade component design systems.",
    stages: [
      {
        ...
        courses: [
          ...
          "JavaScript ES2024 & Browser APIs",
        ],
      },
      {
        name: "React Mastery",
        weeks: "8 weeks",
        courses: [
          "React & Next.js Frontend Development (Full Course)",
          "TypeScript for React Engineers",
      ...
      },
      {
        ...
        weeks: "4 weeks",
        courses: [
          "UI/UX Product Design (Core Modules)",
      ...
      },
      {
        ...
        courses: [
          ...
          "Testing React with Vitest & Playwright",
        ],
      },
      {
    ...
    outcomes: [
      "Production-deployed React/Next.js apps",
      "TypeScript-first component libraries",
...
const comparisonMatrix = [
  ...
  },
  {
    ...
    java: "Very High",
    python: "Extremely High",
    aws: "Very High",
    testing: "High",
    frontend: "High",
  },
  {
    feature: "Prior Coding Needed",
    java: "No",
    python: "No",
    aws: "Helpful",
    testing: "Helpful",
  ...
  {
    feature: "AWS Certification Prep",
    java: "Partial",
    python: "No",
    aws: "SAA-C03 + DVA-C02",
    testing: "No",
