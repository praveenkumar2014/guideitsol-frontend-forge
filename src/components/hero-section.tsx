        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-base font-bold rounded-md bg-primary hover:bg-primary/90 text-white" asChild>
      ...
      <div className="mt-20 border-t border-border bg-surface py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg font-semibold text-foreground mb-8">
            We collaborate with <span className="text-primary">300+ leading universities and companies</span>
          </p>
