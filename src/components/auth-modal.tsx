...
export function AuthModal({ open, onOpenChange }: AuthModalProps) {
  const { user, isAuthenticated, loginAs, loginWithCredentials, loginWithGoogle, logout } = useAuth();
        ...
        <DialogHeader className="text-left">
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            {isAuthenticated
              ...
              : "Sign in with Google OAuth, 1-click test roles, or custom credentials."}
          </DialogDescription>
        </DialogHeader>
        ...
        {!isAuthenticated && (
          <div className="mt-4">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-border/80 bg-surface/80 px-4 py-3 text-sm font-semibold text-foreground shadow-sm transition-all hover:border-primary/50 hover:bg-surface hover:shadow-md"
            >
